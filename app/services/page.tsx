...
export const metadata: Metadata = { title: "Nail Services & Pricing | Kim's Nails", description: "Explore manicures, pedicures, extensions, and custom nail art at Kim's Nails in New York." };
